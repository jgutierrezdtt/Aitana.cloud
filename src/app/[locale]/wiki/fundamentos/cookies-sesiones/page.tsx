    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-cyan-600 py-12">
        <div className="max-w-4xl mx-auto px-6">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 py-1 rounded-lg mb-4">
            ...
            <span className="text-slate-900 dark:text-white text-sm font-medium">Fundamentos</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-4">
            Cookies y Sesiones
          </h1>
          <div className="flex items-center gap-4 text-blue-100">
            <span className="bg-green-500/20 text-green-700 dark:text-green-300 px-3 py-1 rounded-lg text-sm font-medium">
              Principiante
            </span>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white dark:bg-slate-900 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-2xl p-8 md:p-12 space-y-8">
          ...
          {/* Introducción */}
          <section>
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">¿Qué son las Cookies?</h2>
            <p className="text-slate-700 dark:text-slate-300 text-lg leading-relaxed mb-4">
              <strong className="text-white dark:text-white">Las cookies</strong> son pequeños archivos de texto que los sitios web guardan 
            ...
            <p className="text-slate-700 dark:text-slate-300 text-lg leading-relaxed">
              HTTP es un protocolo <strong className="text-white dark:text-white">stateless</strong> (sin estado), es decir, cada petición 
          ...
          {/* Cookies */}
          <section>
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">Cómo Funcionan las Cookies</h2>
            ...
            <div className="space-y-6">
              <div className="bg-blue-500/10 border border-blue-500 dark:border-blue-400/30 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full bg-blue-500 text-slate-900 dark:text-white flex items-center justify-center flex-shrink-0 font-bold">
                      1
                    </div>
                    <div>
                      <p className="text-slate-900 dark:text-white font-semibold">El servidor envía una cookie</p>
                      <code className="text-sm text-green-600 dark:text-green-400 bg-white dark:bg-slate-900 px-3 py-1 rounded mt-1 block">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-slate-900 dark:text-white font-semibold">El navegador guarda la cookie</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-slate-900 dark:text-white font-semibold">El navegador envía la cookie en cada petición</p>
                      <code className="text-sm text-cyan-600 dark:text-cyan-400 bg-white dark:bg-slate-900 px-3 py-1 rounded mt-1 block">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-slate-900 dark:text-white font-semibold">El servidor identifica al usuario</p>
                      <p className="text-slate-700 dark:text-slate-300 text-sm mt-1">
              ...
              <div className="bg-purple-500/10 border border-purple-400/30 rounded-xl p-6">
                <h3 className="text-xl font-bold text-purple-700 dark:text-purple-300 mb-4">Atributos Importantes de Cookies</h3>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white/5 rounded-lg p-4">
                    ...
                    <div className="mt-2 text-xs space-y-1">
                      <p className="text-slate-600 dark:text-slate-400">• <code>Strict</code>: Solo peticiones del mismo sitio</p>
                      <p className="text-slate-600 dark:text-slate-400">• <code>Lax</code>: Permite navegación normal (por defecto)</p>
                      <p className="text-slate-600 dark:text-slate-400">• <code>None</code>: Permite cross-site (requiere Secure)</p>
                    </div>
                  </div>
          ...
          {/* Sesiones */}
          <section>
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">Sesiones del Lado del Servidor</h2>
            
            <p className="text-slate-700 dark:text-slate-300 text-lg leading-relaxed mb-6">
              Una <strong className="text-white dark:text-white">sesión</strong> es un mecanismo para almacenar datos del usuario 
            ...
            <div className="bg-slate-100 dark:bg-slate-800/50 rounded-xl p-6 space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-green-500/10 border border-green-400/30 rounded-lg p-4">
                  <h4 className="text-green-600 dark:text-green-400 font-bold mb-2">✅ Ventajas</h4>
                ...
                <div className="bg-red-500/10 border border-red-400/30 rounded-lg p-4">
                  <h4 className="text-red-600 dark:text-red-400 font-bold mb-2">⚠️ Desventajas</h4>
                  <ul className="text-sm text-slate-700 dark:text-slate-300 space-y-1">
              ...
              <div className="bg-blue-500/10 border border-blue-500 dark:border-blue-400/30 rounded-lg p-4">
                <h4 className="text-blue-700 dark:text-blue-300 font-bold mb-3">Ejemplo de Almacenamiento de Sesión</h4>
...
Set-Cookie: session_id=abc123; HttpOnly; Secure; SameSite=Strict`}
          ...
          <section>
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">JWT: Tokens Sin Estado</h2>
            
            <p className="text-slate-700 dark:text-slate-300 text-lg leading-relaxed mb-6">
              <strong className="text-white dark:text-white">JWT</strong> (JSON Web Token) es una alternativa a las sesiones tradicionales. 
              El servidor firma un token que contiene los datos del usuario, y el cliente lo envía en cada petición.
            </p>

            <div className="bg-purple-500/10 border border-purple-400/30 rounded-xl p-6">
              <h3 className="text-xl font-bold text-purple-700 dark:text-purple-300 mb-4">Estructura de un JWT</h3>
              
              <div className="space-y-3">
                <div className="bg-white dark:bg-slate-900 rounded-lg p-4">
                  <code className="text-xs text-red-600 dark:text-red-400 block mb-1">HEADER (algoritmo)</code>
                  <code className="text-sm text-slate-700 dark:text-slate-300">eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9</code>
                </div>
                <div className="text-center text-slate-500">.</div>
                <div className="bg-white dark:bg-slate-900 rounded-lg p-4">
                  <code className="text-xs text-purple-400 block mb-1">PAYLOAD (datos del usuario)</code>
                  <code className="text-sm text-slate-700 dark:text-slate-300">eyJ1c2VySWQiOjQyLCJ1c2VybmFtZSI6ImFsaWNlIn0</code>
                </div>
                <div className="text-center text-slate-500">.</div>
                <div className="bg-white dark:bg-slate-900 rounded-lg p-4">
                  <code className="text-xs text-blue-600 dark:text-blue-400 block mb-1">SIGNATURE (firma digital)</code>
                  <code className="text-sm text-slate-700 dark:text-slate-300">SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c</code>
                </div>
              </div>
          ...
          <section>
            <div className="bg-red-500/10 border border-red-400/30 rounded-xl p-6">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-red-700 dark:text-red-300">Vulnerabilidades Comunes</h3>
                  
                  <div className="space-y-3">
                    <div>
                      <h4 className="text-slate-900 dark:text-white font-semibold mb-1">🔓 Session Hijacking</h4>
                      <p className="text-slate-700 dark:text-slate-300 text-sm">
                    ...
                    <div>
                      <h4 className="text-slate-900 dark:text-white font-semibold mb-1">🔓 Session Fixation</h4>
                      <p className="text-slate-700 dark:text-slate-300 text-sm">
                    ...
                    <div>
                      <h4 className="text-slate-900 dark:text-white font-semibold mb-1">🔓 XSS robando cookies</h4>
                      <p className="text-slate-700 dark:text-slate-300 text-sm">
                    ...
                    <div>
                      <h4 className="text-slate-900 dark:text-white font-semibold mb-1">🔓 JWT en localStorage</h4>
                      <p className="text-slate-700 dark:text-slate-300 text-sm">
          ...
          {/* Ejemplo Práctico */}
          <section>
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Cookie Segura vs Insegura</h2>
            
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-red-500/5 border border-red-400/30 rounded-xl p-6">
                <h3 className="text-lg font-bold text-red-700 dark:text-red-300 mb-3">❌ Cookie Insegura</h3>
...
{`Set-Cookie: session=abc123`}
              ...
              <div className="bg-green-500/5 border border-green-400/30 rounded-xl p-6">
                <h3 className="text-lg font-bold text-green-700 dark:text-green-300 mb-3">✅ Cookie Segura</h3>
                <pre className="text-sm text-green-600 dark:text-green-400 overflow-x-auto">
{`Set-Cookie: session=abc123;
  HttpOnly;
  Secure;
